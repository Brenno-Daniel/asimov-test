...
function HeroContent() {
  return (
    <section className="mx-auto max-w-7xl px-5 lg:px-8 lg:pt-[70px] lg:pb-0">
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="order-2 flex flex-col gap-8 text-center lg:order-1 lg:text-left">
          ...
          <p className="max-w-lg mx-auto lg:mx-0 text-xl leading-7 text-foreground/90 lg:text-left">
          ...
          <button className="w-fit mx-auto lg:mx-0 rounded-xl bg-foreground px-8 py-4 text-xl font-normal leading-7 text-background transition-all hover:bg-foreground/90 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]">
            Book a consultation
          </button>
        </div>
...
function ClientLogos() {
  return (
    <section className="mx-auto max-w-7xl px-5 lg:px-8 pt-12 lg:pt-[70px] lg:pb-0">
      <div className="flex flex-wrap items-center justify-center gap-8 grayscale md:gap-12 lg:justify-between lg:gap-8">
        {clientLogos.map((logo) => (
          <div key={logo.name} className={`flex h-8 items-center justify-center ${logo.width}`}>
